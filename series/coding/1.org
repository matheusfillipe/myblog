...
Start cloning both repos:

#+begin_src shell
git clone https://github.com/drgrice1/web2js.git
git clone https://github.com/drgrice1/tikzjax.git
#+end_src

** Building web2js

#+begin_src shell
sudo npm -g i wasm-opt  # install webassembler compiler if you havent
cd web2js
