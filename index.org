...
* WELCOME
What is this? The aesthetics of the 90's internet with webgl? Don't worry, if the 3D background effects are killing your cpu you can disable them with the top left "FX" checkbox. There is also a terminal for hackers on that corner.

This is my personal website/blog build with emacs org-mode. The fancy background was made with [[https://threejs.org/][threejs]].
