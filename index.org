...
* WELCOME
This is my personal homepage/blog build with emacs org-mode. Don't forget to check out the terminal and the fancy 3D mode on the left corner. This fancy background was made with [[https://threejs.org/][threejs]].
...
- [[file:series/coding/1.org][Getting Tikz exports with org mode]]
- [[file:series/coding/2.org][Comments with firebase]]
